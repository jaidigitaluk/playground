...
if __name__ == "__main__":
    ...
    raise SystemExit(run(ENDPOINT,{"keywords":a.keywords[:1000],"location_code":a.location_code,"language_code":a.language_code},"keyword-difficulty",Path(__file__).resolve().parents[1]))
